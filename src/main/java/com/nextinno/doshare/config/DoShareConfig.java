 ...
 *
 */
public class DoShareConfig {

    private static final Logger logger = LoggerFactory.getLogger(DoShareConfig.class);

    private static final String PROCESS_NAME = "doshare"; // 프로세스 이름
    public static final String DEFAULT_BASE_PACKAGE = "com.nextinno.doshare";
